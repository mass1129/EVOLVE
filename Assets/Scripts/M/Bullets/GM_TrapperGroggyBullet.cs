...
public class GM_TrapperGroggyBullet : GM_Bullet
{
    ...
    void Start()
    {
        firePos = GameObject.Find("TrapperGroggyFirePos").transform;
        aimLookAt = GameObject.Find("TrapperAimLookAt").transform;
