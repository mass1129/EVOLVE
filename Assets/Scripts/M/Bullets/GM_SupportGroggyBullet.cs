...
public class GM_SupportGroggyBullet : GM_Bullet
{
    ...
    void Start()
    {
        firePos = GameObject.Find("SupportGroggyFirePos").transform;
        aimLookAt = GameObject.Find("SupportAimLookAt").transform;
