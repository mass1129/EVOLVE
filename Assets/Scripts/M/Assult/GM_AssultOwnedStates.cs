...
namespace GM_AssultOwnedStates
{
    ...
    public class Pushed : GM_State<GM_Hunter>
    {
        ...
        public override void Exit(GM_Hunter entity)
        {
            ...
            entity.GetComponent<GM_PlayerRot>().ry = entity.transform.localEulerAngles.y;
        }
    }
    ...
    public class Death : GM_State<GM_Hunter>
    {
        ...
        public override void Execute(GM_Hunter entity)
        {
            ...
            entity.respawnTimeText.text = $"00 : {((int)(entity.respawnWaitTime)).ToString("D2")}";
            // 일정 시간 이후
    ...
    public class Global : GM_State<GM_Hunter>
    {
        ...
        float barrierWaitTime = 40;
        float barrierCoolTime = 40;     // 스킬2 쿨타임. 스킬 사용과 동시에 0으로 변하며, 바로 다시 증가.
        ...
        public override void Execute(GM_Hunter entity)
        {
            ...
            // Assult 스킬 2 발동 (방어막 충전)
            if (Input.GetKeyDown(KeyCode.Alpha4) && barrierCoolTime > barrierWaitTime)
            {
                entity.Barrier += 80;
                entity.AssultBarrier();
                barrierCoolTime = 0;
            }
